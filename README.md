...
V1.73a+OH1VX-r2 ... ??, ?? ???? ... Bandplan updated to show emergency frequency, broadcast frequency, digital mode bandwidths. More robust beacon lock. Added a new color palette for waterfall (cold->hot).  More robust beacon lock. Added a new color palette for waterfall (cold->hot). Automatic search, if beacon locking is lost.
